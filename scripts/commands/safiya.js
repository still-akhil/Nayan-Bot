...
module.exports = {
  config: {
    ...
    aliases: ["mim"],
    permission: 0,
    credits: "Slim Shẫdy - Akhil Rashed",
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "Oh yes daddy, Come closer, let’s see how bad you can be..🫦🥵",
          "Yes daddy, keep talking, you’re setting my soul ablaze..🥵😩",
          "Yes daddy..🫦🥵",
          "Oh yes daddy..🫦🥵",
          "Yes daddy, One word from you, and I’m falling into the heat..😩",
          "Yes daddy, keep talking like that, I’m losing all control..🫦😩",
          "Yes daddy, stop teasing, you’re burning me up.. 🫦🥵",
          "Yes daddy, keep talking, you’re making me weak..🫦😘",
          "Come closer, let’s see how bad you can be..🫦🥵"
        ];
